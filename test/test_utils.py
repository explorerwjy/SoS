...
from sos.target import executable, remote, targets
...
''')
        ...
        for section in wf.sections:
            ...
            if section.names[0][1] == '1':
                ...
                self.assertEqual(res['step_depends'], targets())
                self.assertEqual(res['step_output'], targets())
                ...
                self.assertEqual(res['step_input'], targets())
                self.assertEqual(res['step_depends'], targets('some.txt', executable('ls')))
